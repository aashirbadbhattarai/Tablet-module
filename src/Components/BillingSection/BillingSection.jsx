    ...
    <>
      <div className="bg-[#F4F0F0] w-[25rem] h-svh p-4">
        ...
        <div className="flex justify-between">
          <span className="w-[45%] rounded-xl bg-blue-200 p-2 text-center">
            123
          </span>
          <span className="w-[45%] rounded-xl bg-blue-200 p-2 text-center">
            Table name
        ...
        <div className="flex mt-6 gap-x-2">
          <BillingOptions
            label="Print ticket"
            color="blue"
            onClick={() => setActiveTicket('printTicket')}
          />
          <BillingOptions
            label="Transfer Order"
            color="blue"
            onClick={() => setActiveTicket('orderTransfer')}
          />
          <BillingOptions
            label="Place Order"
            color="blue"
            onClick={() => setActiveTicket('orderPlacement')}
          />
        </div>
        ...
        <div className="flex mt-2 gap-x-7">
          ...
          <BillingOptions
            label="Print Order"
            color="green"
            onClick={() => setActiveTicket('orderPrint')}
          />
          <BillingOptions
            label="Bill Payment"
            color="green"
            onClick={() => setActiveTicket('payment')}
          />
        </div>
      </div>
